// Bare bonesBare bones ADXL345 i2c example for Arduino 1.0
...
// If you need more advanced features such as freefall and tap detection, check out this
// (now utdated) lib that I based my code on http://code.google.com/p/adxl345driver
// It will need some updating, but only basic stuff
//
